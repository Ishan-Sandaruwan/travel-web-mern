  ...
  return (
    <div className="bg-gradient-to-r from-emerald-300 to-lime-400 p-4">
      <div className="mb-4 flex justify-between gap-8 items-center">
        <span className="md:text-2xl font-bold text-white bg-gradient-to-r from-green-400 to-blue-500 p-2 rounded-md shadow-md hover:to-lime-400 transition-transform cursor-pointer">
          Travel Guider
        </span>
        <div className="flex-grow font-semibold flex justify-evenly text-lime-800 drop-shadow ">
